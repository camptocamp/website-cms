...
class CMSNotificationCase(TransactionCase):
    ...
    def setUp(self):
        ...
        add_xmlid(self.env, self.subtype1, 'cms_notifications.test_subtype1')
        self.subtype2 = self.subtype_model.create(
            {'name': 'Back to the future II'})
        add_xmlid(self.env, self.subtype2, 'cms_notifications.test_subtype2')
        self.subtype3 = self.subtype_model.create(
            {'name': 'Back to the future III'})
        add_xmlid(self.env, self.subtype3, 'cms_notifications.test_subtype3')
